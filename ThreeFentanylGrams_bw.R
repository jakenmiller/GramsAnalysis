# Collapse sections with four #### as needed.
...
#### Data Compilation ####
## This data compilation section should be skipped if you have access to the
# intermediate file CompiledGramsTotalFentanyl.csv, which is located
...
## or if you have access to the csv on the github repo.

## Set your working directory to the location of the primary csv
## setwd("C:/Users/jacobmiller21/Desktop/Darknet Data")
...
## Set working directory to wherever bitcoin prices are stored.
## See github repo for cleaned version of the file.
